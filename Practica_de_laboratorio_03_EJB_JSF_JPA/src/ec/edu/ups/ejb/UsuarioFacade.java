...
public class UsuarioFacade extends AbstractFacade<Usuario> {
	...
	public void elimina(int id) {
		...
		String query = "UPDATE Usuario e " + "SET e.estado='E' " + "WHERE  e.id=" + id;
	...
	public void acti(int id) {
		// Usuario usu=new Usuario();
		String query = "UPDATE Usuario e " + "SET e.estado='A' " + "WHERE  e.id=" + id;
		System.out.println(query);
		em.createQuery(query).executeUpdate();
	}
	...
	public Usuario buscarid(String correo) {
		Usuario us = new Usuario();
		String query = "SELECT e " + "FROM Usuario e " + "WHERE  e.correo = '" + correo + "'";
		us = em.createQuery(query, Usuario.class).getSingleResult();
		System.out.println(query);
		return us;
	}
