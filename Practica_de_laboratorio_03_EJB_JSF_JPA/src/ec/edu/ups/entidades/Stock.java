...
public class Stock implements Serializable {
	...
	public static List<Stock> serializeStock(List<Stock> stocks) {
		...
		stocks.forEach(s -> {
			...
			producto2 = new Producto(s.getProducto().getId(), s.getProducto().getNombre(),
					s.getProducto().getDescripcion(), s.getProducto().getPreciounitario(),
					s.getProducto().getPreciopublico(), s.getProducto().getStock());
